...
export function GalleryWalkthrough({ room, artworks, artist, backHref = "/" }: GalleryWalkthroughProps) {
            ...
            <div className="space-y-1">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">by {artist?.display_name || 'Unknown Artist'}</p>
                </div>
              </div>
            </div>
          ...
          <Card className="bg-background/90 backdrop-blur-lg border-2 shadow-2xl p-6 space-y-4">
            ...
            <div className="flex items-center gap-4 pt-4 border-t">
              <div className="flex items-center gap-2 text-sm">
                ...
                <span>{artist?.display_name || 'Unknown Artist'}</span>
              </div>
